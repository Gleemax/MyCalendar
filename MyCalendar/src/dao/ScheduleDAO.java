...
public class ScheduleDAO extends BaseHibernateDAO {
	...
	// property constants
	public static final String SCH_CONTENT = "schContent";
	...
	public Schedule findById(java.lang.Integer id) {
		...
		try {
			Schedule instance = (Schedule) getSession().get("model.Schedule", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Schedule instance) {
		...
		try {
			List results = getSession().createCriteria("model.Schedule")
	...
	public List findBySchContent(Object schContent) {
		return findByProperty(SCH_CONTENT, schContent);
	}
